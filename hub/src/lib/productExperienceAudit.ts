...
const ROUTE_OVERRIDES: Partial<Record<string, Partial<Pick<ExperienceRoute, 'shell' | 'responsive' | 'states' | 'interaction' | 'accessibility'>>>> = {
  ...
  '/about': { shell: 'complete', responsive: 'complete', states: 'complete' },
  '/faq': { shell: 'complete', responsive: 'complete', states: 'complete' },
  '/support': { shell: 'complete', responsive: 'complete', states: 'complete', interaction: 'complete' },
