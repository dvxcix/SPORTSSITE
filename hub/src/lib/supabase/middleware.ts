...
export async function updateSession(request: NextRequest) {
  ...
  if (['/api/admin/fanduel-import', '/api/admin/mgm-import', '/api/admin/pikkit-import', '/api/admin/browserbase-sessions', '/api/admin/pikkit-context-check', '/api/admin/whop-addon-reconcile'].includes(request.nextUrl.pathname)) {
    return NextResponse.next({ request })
  }
