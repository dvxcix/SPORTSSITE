...
export const TRACKED_PIPELINES: PipelineDefinition[] = [
  ...
  { name: 'research-mechanics-precompute', label: 'HR mechanics window cache', schedule: 'Hourly morning gate and lineup-triggered', staleAfterMinutes: daily, area: 'MLB data' },
  { name: 'market-dna-maintenance', label: 'Market DNA maintenance', schedule: 'Daily', staleAfterMinutes: daily, area: 'MLB data' },
  ...
  { name: 'process-contact-alerts', label: 'Instant contact alerts', schedule: 'Every minute + feed wake-up', staleAfterMinutes: 5, area: 'Maintenance' },
  { name: 'publish-scheduled-posts', label: 'Creator scheduled publishing', schedule: 'Every minute', staleAfterMinutes: everyMinute, area: 'Maintenance' },
