...
import { Award, BarChart3, ChevronRight, Compass, FlaskConical, Hash, Layers3, LayoutDashboard, MessageCircle, Search, Settings, ShieldCheck, Table2, UserRound, Users, X } from 'lucide-react'
