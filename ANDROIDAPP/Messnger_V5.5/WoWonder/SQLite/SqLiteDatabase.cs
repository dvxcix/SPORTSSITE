...
namespace WoWonder.SQLite
{
    public class SqLiteDatabase
    {
        ...
        internal static readonly string PathCombine = Path.Combine(Folder, AppSettings.DatabaseName + "Db24_.db");
            ...
            try
            {
                ...
                if (resultInfoTb != null)
                {
                    resultInfoTb = new DataTables.MyProfileTb
                    {
                        ...
                        ConvertedPoints = info.ConvertedPoints,
                        Credits = info.Credits,
                        FortumoHash = info.FortumoHash,
                        GoogleSecret = info.GoogleSecret,
                        HaveMonetization = info.HaveMonetization,
                        IsReportedUser = info.IsReportedUser,
                        IsVerified = info.IsVerified,
                        NgeniusRef = info.NgeniusRef,
                        Okru = info.Okru,
                        PhonePrivacy = info.PhonePrivacy,
                        ProRemainder = info.ProRemainder,
                        SecurionpayKey = info.SecurionpayKey,
                        TwoFactorMethod = info.TwoFactorMethod,
                        TwoFactorHash = info.TwoFactorHash,
