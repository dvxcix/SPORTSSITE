    ...
    public class SuperTextView : TextView
    {
        ...
        private void Init(Context context)
        {
            try
            {
                ...
                SetSelectedStateColor(Color.ParseColor(AppSettings.MainColor));
                //EnableUnderLine();
        ...
        public void SetTextInfo(SuperTextView showMore)
        {
            try
            {
                if (showMore != null)
                {
                    ...
                    showMore.SetSelectedStateColor(Color.ParseColor(AppSettings.MainColor));
        ...
        private SpannableString MakeSpannAbleString(ICharSequence text)
        {
            try
            {
                ...
                foreach (var autoLinkItem in autoLinkItems)
                {
                    ...
                    var indexFrom = autoLinkItem.GetStartPoint();
                    ...
                    var indexLast = autoLinkItem.GetEndPoint();
                    ...
                    spannableString.SetSpan(clickAbleSpan, indexFrom, indexLast, SpanTypes.ExclusiveExclusive);
                    ...
                    if (MBoldAutoLinkModes != null && MBoldAutoLinkModes.Contains(autoLinkItem.GetAutoLinkMode()))
                    {
                        ...
                        spannableString.SetSpan(new StyleSpan(TypefaceStyle.Bold), indexFrom, indexLast, SpanTypes.ExclusiveExclusive);
                    }
                }
