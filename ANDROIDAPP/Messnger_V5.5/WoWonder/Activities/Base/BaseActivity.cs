...
namespace WoWonder.Activities.Base
{
    ...
    public class BackCallAppBase1 : OnBackPressedCallback
    {
        ...
        public override void HandleOnBackPressed()
        {
            try
            {
                ...
                {
                    BackCallWoWonderTools.OnBackPressed(Activity, PageName);
                }
            }
            catch (Exception e)
            {
    ...
    public static class BackCallWoWonderTools
    {
            ...
            try
            {
                if (string.IsNullOrEmpty(pageName))
                {
                ...
                else switch (pageName)
                    {
                        ...
                        case "EditImageActivity":
                            {
                                var subActivity = activity as EditImageActivity;
                                subActivity?.BackPressed();
                                break;
                            }
                        ...
                        case "FaceFiltersActivity":
                            {
                                var subActivity = activity as FaceFiltersActivity;
                                subActivity?.BackPressed();
                                break;
                            }
                    }
