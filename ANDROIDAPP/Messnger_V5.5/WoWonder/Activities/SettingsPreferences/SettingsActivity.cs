...
namespace WoWonder.Activities.SettingsPreferences
{
    ...
    public class SettingsActivity : BaseActivity, IDialogListCallBack
    {
        ...
        public ImageView ImageUser, IconMore;
        ...
        private ImageView IconOpenEditProfile, IconOpenMyAccount, IconOpenBlockUser, IconOpenDeleteAccount, IconOpenLogout;
        ...
        private ImageView IconOpenWallpaper, IconOpenTheme, IconOpenChangePassword, IconOpenTwoFactor, IconOpenManageSessions;
        ...
        private ImageView IconOpenStorageConnectedMobile, IconOpenStorageConnectedWiFi;
        ...
        private ImageView IconOpenWhoCanFollowMe, IconOpenWhoCanMessageMe, IconOpenWhoCanSeeMyBirthday;
        ...
        private TextView InviteFriendsLayout, RateOurAppLayout, AboutUsLayout, ContactUsLayout, PrivacyPolicyLayout, TermsOfUseLayout;
        ...
        private void InitComponent()
        {
            try
            {
                ...
                IconOpenEditProfile = FindViewById<ImageView>(Resource.Id.iconOpen_EditProfile);

                MyAccountLayout = FindViewById<LinearLayout>(Resource.Id.MyAccountLayout);
                IconOpenMyAccount = FindViewById<ImageView>(Resource.Id.iconOpen_MyAccount);

                BlockUserLayout = FindViewById<LinearLayout>(Resource.Id.BlockUserLayout);
                IconOpenBlockUser = FindViewById<ImageView>(Resource.Id.iconOpen_BlockUser);

                DeleteAccountLayout = FindViewById<LinearLayout>(Resource.Id.DeleteAccountLayout);
                IconOpenDeleteAccount = FindViewById<ImageView>(Resource.Id.iconOpen_DeleteAccount);

                LogoutLayout = FindViewById<LinearLayout>(Resource.Id.LogoutLayout);
                IconOpenLogout = FindViewById<ImageView>(Resource.Id.iconOpen_Logout);

                WallpaperLayout = FindViewById<LinearLayout>(Resource.Id.WallpaperLayout);
                IconOpenWallpaper = FindViewById<ImageView>(Resource.Id.iconOpen_Wallpaper);
                ...
                IconOpenTheme = FindViewById<ImageView>(Resource.Id.iconOpen_Theme);

                ChangePasswordLayout = FindViewById<LinearLayout>(Resource.Id.ChangePasswordLayout);
                IconOpenChangePassword = FindViewById<ImageView>(Resource.Id.iconOpen_ChangePassword);

                TwoFactorLayout = FindViewById<LinearLayout>(Resource.Id.TwoFactorLayout);
                IconOpenTwoFactor = FindViewById<ImageView>(Resource.Id.iconOpen_TwoFactor);

                ManageSessionsLayout = FindViewById<LinearLayout>(Resource.Id.ManageSessionsLayout);
                IconOpenManageSessions = FindViewById<ImageView>(Resource.Id.iconOpen_ManageSessions);
                ...
                IconOpenStorageConnectedMobile = FindViewById<ImageView>(Resource.Id.iconOpen_StorageConnectedMobile);
                ...
                IconOpenStorageConnectedWiFi = FindViewById<ImageView>(Resource.Id.iconOpen_StorageConnectedWiFi);
                ...
                IconOpenWhoCanFollowMe = FindViewById<ImageView>(Resource.Id.iconOpen_WhoCanFollowMe);
                ...
                IconOpenWhoCanMessageMe = FindViewById<ImageView>(Resource.Id.iconOpen_WhoCanMessageMe);
                ...
                IconOpenWhoCanSeeMyBirthday = FindViewById<ImageView>(Resource.Id.iconOpen_WhoCanSeeMyBirthday);
                ...
                {
                    IconOpenEditProfile.Rotation = 0;
                    IconOpenMyAccount.Rotation = 0;
                    IconOpenBlockUser.Rotation = 0;
                    IconOpenDeleteAccount.Rotation = 0;
                    IconOpenLogout.Rotation = 0;

                    IconOpenWallpaper.Rotation = 0;
                    IconOpenTheme.Rotation = 0;
                    IconOpenChangePassword.Rotation = 0;
                    IconOpenTwoFactor.Rotation = 0;
                    IconOpenManageSessions.Rotation = 0;

                    IconOpenStorageConnectedMobile.Rotation = 0;
                    IconOpenStorageConnectedWiFi.Rotation = 0;

                    IconOpenWhoCanFollowMe.Rotation = 0;
                    IconOpenWhoCanMessageMe.Rotation = 0;
                    IconOpenWhoCanSeeMyBirthday.Rotation = 0;
                }
            }
            catch (Exception e)
            {
        ...
        private void IconMoreOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                AboutUsLayout = popupView.FindViewById<TextView>(Resource.Id.AboutUsLayout);
                ...
                AboutUsLayout.Click += AboutUsLayoutOnClick;
        ...
        private void TermsOfUseLayoutOnClick(object sender, EventArgs e)
        {
            try
            {
                new IntentController(this).OpenBrowserFromPhone(InitializeWoWonder.WebsiteUrl + "/terms/terms");
                PopupWindow?.Dismiss();
            }
            catch (Exception exception)
            {
        ...
        private void PrivacyPolicyLayoutOnClick(object sender, EventArgs e)
        {
            try
            {
                new IntentController(this).OpenBrowserFromPhone(InitializeWoWonder.WebsiteUrl + "/terms/privacy-policy");
                PopupWindow?.Dismiss();
            }
            catch (Exception exception)
            {
        ...
        private void ContactUsLayoutOnClick(object sender, EventArgs e)
        {
            try
            {
                new IntentController(this).OpenBrowserFromPhone(InitializeWoWonder.WebsiteUrl + "/contact-us");
                PopupWindow?.Dismiss();
            }
            catch (Exception exception)
            {
        ...
        private void AboutUsLayoutOnClick(object sender, EventArgs e)
        {
            try
            {
                new IntentController(this).OpenBrowserFromPhone(InitializeWoWonder.WebsiteUrl + "/terms/about-us");
                PopupWindow?.Dismiss();
            }
            catch (Exception exception)
            {
...
#pragma warning restore CS0618
        ...
        private void LoadDataUser(UserDataObject data)
        {
            try
            {
                ...
                if (AppSettings.FlowDirectionRightToLeft)
                    TxtName.SetCompoundDrawablesWithIntrinsicBounds(data.Verified == "1" ? Resource.Drawable.icon_checkmark_small_vector : 0, 0, 0, 0);
                else
                ...
                SwitchChatHeads.Checked = UserDetails.ChatHead = MainSettings.SharedData?.GetBoolean("chatheads_key", ChatHeadHelper.GetInstance(this).CheckPermission()) ?? false;
