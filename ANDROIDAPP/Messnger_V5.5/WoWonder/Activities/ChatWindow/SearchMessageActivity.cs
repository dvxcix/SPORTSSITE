                ...
                if (item != null)
                {
                    switch (e.Type)
                    {
                        ...
                        case TypeClick.Video:
                            {
                                var fileName = item.MesData.Media.Split('/').Last();
                                var mediaFile = WoWonderTools.GetFile(Id, Methods.Path.FolderDcimVideo, fileName, item.MesData.Media, "video");
                        ...
                        case TypeClick.Image:
                            {
                                ...
                                {
                                    var fileName = item.MesData.Media.Split('/').Last();
                                    var mediaFile = WoWonderTools.GetFile(Id, Methods.Path.FolderDcimImage, fileName, item.MesData.Media, "image");
