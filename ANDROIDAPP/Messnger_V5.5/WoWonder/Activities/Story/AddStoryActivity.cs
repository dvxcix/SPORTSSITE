...
namespace WoWonder.Activities.Story
{
    ...
    public class AddStoryActivity : BaseActivity
    {
        ...
        private ImageView EditButton, EmojisView;
        ...
        private void InitComponent()
        {
            try
            {
                ...
                EditButton = FindViewById<ImageView>(Resource.Id.editButton);
        ...
        protected override void OnActivityResult(int requestCode, Result resultCode, Intent data)
        {
            try
            {
                ...
                if (requestCode == 3000 && resultCode == Result.Ok)// Image Editor
                {
        ...
        private void SetImageStory(string url)
        {
            try
            {
                ...
                GlideImageLoader.LoadImage(this, url, StoryImageView, ImageStyle.CenterCrop, ImagePlaceholders.Drawable);
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);
