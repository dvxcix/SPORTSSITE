    ...
    public class StoryShowAdapterViewHolder : RecyclerView.ViewHolder, View.IOnClickListener, View.IOnLongClickListener
    {
        ...
        private void InitializingReactImages(View view)
        {
            try
            {
                ...
                Glide.With(MAdapter.ActivityContext?.BaseContext).Load(Resource.Drawable.emoji_like).Apply(new RequestOptions().CenterCrop()).Into(MImgButtonOne);
                Glide.With(MAdapter.ActivityContext?.BaseContext).Load(Resource.Drawable.emoji_love).Apply(new RequestOptions().CenterCrop()).Into(MImgButtonTwo);
                Glide.With(MAdapter.ActivityContext?.BaseContext).Load(Resource.Drawable.emoji_haha).Apply(new RequestOptions().CenterCrop()).Into(MImgButtonThree);
                Glide.With(MAdapter.ActivityContext?.BaseContext).Load(Resource.Drawable.emoji_wow).Apply(new RequestOptions().CenterCrop()).Into(MImgButtonFour);
                Glide.With(MAdapter.ActivityContext?.BaseContext).Load(Resource.Drawable.emoji_sad).Apply(new RequestOptions().CenterCrop()).Into(MImgButtonFive);
                Glide.With(MAdapter.ActivityContext?.BaseContext).Load(Resource.Drawable.emoji_angry).Apply(new RequestOptions().CenterCrop()).Into(MImgButtonSix);

                ReactConstants.SetTranslateAnimation(MAdapter.ActivityContext?.BaseContext, MImgButtonOne, ReactConstants.Like);
                ReactConstants.SetTranslateAnimation(MAdapter.ActivityContext?.BaseContext, MImgButtonTwo, ReactConstants.Love);
                ReactConstants.SetTranslateAnimation(MAdapter.ActivityContext?.BaseContext, MImgButtonThree, ReactConstants.HaHa);
                ReactConstants.SetTranslateAnimation(MAdapter.ActivityContext?.BaseContext, MImgButtonFour, ReactConstants.Wow);
                ReactConstants.SetTranslateAnimation(MAdapter.ActivityContext?.BaseContext, MImgButtonFive, ReactConstants.Sad);
                ReactConstants.SetTranslateAnimation(MAdapter.ActivityContext?.BaseContext, MImgButtonSix, ReactConstants.Angry);
